...
int _cdenv(info_t *);
int _cdsetenv(info_t *);
int _cdunsetenv(info_t *);
...
char **list_to_stringsnow(list_t *);
size_t print_list(const list_t *);
list_t *node_starts_with(list_t *, char *, char);
ssize_t get_node_index(list_t *, list_t *);

int is_chainnow(info_t *, char *, size_t *);
void check_chainnow(info_t *, char *, size_t *, size_t, size_t);
int replace_alias(info_t *);
int replace_varsace(info_t *);
int replace_stringname(char **, char *);
