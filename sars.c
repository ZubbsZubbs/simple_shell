...
/**
 * check_chain - Checks if the current command chain should be executed
 * @info: Pointer to info_t struct
 * @buf: Pointer to the command buffer
 * @p: Pointer to the index in the command buffer
...
/**
 * replace_alias - Replaces the first argument with an alias if one exists
 * @info: Pointer to info_t struct
 *
...
/**
 * replace_vars - Replaces any variables in the command arguments
 * @info: Pointer to info_t struct
 *
 ...
 * @new: Pointer to the new string to replace the old one
 *
